...
import { getPendingMotivationalWriterProfiles, approveProfile, deleteProfileApprovalRequest } from '../../../../../Actions/adminActions/profileapprovalActions';
...
class ApproveMotivationalWriterProfile extends Component {
 ...
 componentDidMount() {
  ...
  render() {
   ...
   let linkedInLink;
    ...
    if(profile._id === this.props.match.params.PendingMotivationalWriterProfileId){
    ...
    if (profile.linkedInLink) {
     ...
     return (
      ...
      <Link to = '/PendingMotivationalWriterProfiles' className = "btn btn-light mb-3">
      Back to Pending Motivational Writer Profiles
      </Link>
      </div>
      </div>
...
ApproveMotivationalWriterProfile.propTypes = {
...
export default connect(mapStateToProps, {getPendingMotivationalWriterProfiles, approveProfile, deleteProfileApprovalRequest})(withRouter(ApproveMotivationalWriterProfile));
