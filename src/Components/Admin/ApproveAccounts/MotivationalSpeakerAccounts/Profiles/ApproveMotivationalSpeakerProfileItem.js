...
class ApproveMotivationalSpeakerProfileItem extends Component {
      ...
      <div className = "card card-body bg-light mb-3">
          ...
          <div className = "row">
            ...
            <div className = "col-lg-6 col-md-4 col-8">
                ...
                <Link to = {`/PendingMotivationalSpeakerProfile/${profiles._id}`}  className = "btn btn-success mr-1">
                View Profile
...
ApproveMotivationalSpeakerProfileItem.propTypes = {
...
const mapStateToProps = (state) => ({
  ...
  export default connect(mapStateToProps, { approveProfile, deleteProfileApprovalRequest})(withRouter(ApproveMotivationalSpeakerProfileItem));
