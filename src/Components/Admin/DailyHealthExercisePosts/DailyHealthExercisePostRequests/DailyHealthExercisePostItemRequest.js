...
class DailyHealthExercisePostItemRequest extends Component {
  ...
  {post.uploadedBy.personImage ? (
    ...
    />
                ...
                <div className="col-md-10">
                  ...
                  <Link to = {`/DailyHealthExercisePostRequests/${post._id}`}>View Full Post</Link> 
...
DailyHealthExercisePostItemRequest.propTypes = {

    approveDailyHealthExercisePostRequest: PropTypes.func.isRequired,
    deleteDailyHealthExercisePostRequest: PropTypes.func.isRequired,
...
export default connect(mapStateToProps, { approveDailyHealthExercisePostRequest, deleteDailyHealthExercisePostRequest })(DailyHealthExercisePostItemRequest);
