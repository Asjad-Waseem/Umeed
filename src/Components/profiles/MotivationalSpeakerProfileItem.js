...
class MotivationalSpeakerProfileItem extends Component {
  render() {
      ...
      <div className="card card-body bg-light mb-3">
        <div className="row">
          ...
          <div className="col-lg-6 col-md-4 col-8">
            ...
            <Link
              to={`/MotivationalSpeakerProfile/${profiles._id}`}
...
MotivationalSpeakerProfileItem.propTypes = {
...
export default connect(mapStateToProps)(MotivationalSpeakerProfileItem);
