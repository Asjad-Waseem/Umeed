...
class MotivationalWriterProfileItem extends Component {
  render() {
      ...
      <div className="card card-body bg-light mb-3">
        <div className="row">
          ...
          <div className="col-lg-6 col-md-4 col-8">
            ...
            <Link
              to={`/MotivationalWriterProfile/${profiles._id}`}
...
MotivationalWriterProfileItem.propTypes = {
...
export default connect(mapStateToProps)(MotivationalWriterProfileItem);
