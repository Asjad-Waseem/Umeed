...
class MotivationalWriterSignUpForm extends Component{
             ...
             <div className="container">
               <div className="row">
                 <div className="col-md-8 m-auto">
                  ...
                  <h1 className="display-4 text-center text-light">Sign Up (Motivational Writer)</h1>

                  <p className="lead text-center">Fill up the Sign up form below to sign up as a Motivational Writer at Umeed today</p>
...
MotivationalWriterSignUpForm.propTypes = {
...
export default connect(mapStateToProps, {registerUser})(withRouter(MotivationalWriterSignUpForm));