...
class RegisteredPsychologistProfile extends Component {
  ...
  this.state.PsychologistId = psychologistId;
      ...
      <div className="container">
        <div className="row">
          <div className="col-md-6">
            <Link to="/RegisteredPsychologistProfiles" className="btn btn-light mb-3">
              Back to Registered Psychologist Profiles
            </Link>
          </div>
        </div>
            ...
            <div className="card card-body bg-success text-white mb-3">
              ...
              <div className="text-center">
                ...
                <p className="lead text-center">
                  {profileRole === "Psychologist" ? "Psychologist" : null}
                </p>
                ...
                <Link
                  to={`/MakeAPayment/${psychologistId}`}
                ...
                <Link
                to={`/PsychologistFeedback/${psychologistId}`}
                ...
                <Link
                to={`/ReportProfile/${psychologistId}`}
...
<div className="row">
  <div className="col-md-12">
    <div className="card card-body bg-light mb-3 text-center">
      ...
      <Link to={`/MakeAPayment/${psychologistId}`} style = {{color: "Black"}}>
...
RegisteredPsychologistProfile.propTypes = {
...
const mapStateToProps = (state) => ({
  profile: state.registeredPsychologists,
  auth: state.auth,
  slots: state.payment.bookedSlots,
});

export default connect(mapStateToProps, { getRegisteredPsychologistProfiles, selectTextChatSession, selectVideoChatSession, checkAvailableSlots}) (withRouter(RegisteredPsychologistProfile));
