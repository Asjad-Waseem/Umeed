...
class MotivationalSpeakerDashboard extends Component {
    ...
    MotivationalSpeakerDashboard.propTypes = {
    ...
    const mapStateToProps = (state) => ({
        ...
        export default connect(mapStateToProps)(MotivationalSpeakerDashboard);
