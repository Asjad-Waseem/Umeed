...
class MotivationalWriterDashboard extends Component {
    ...
    MotivationalWriterDashboard.propTypes = {
    ...
    const mapStateToProps = (state) => ({
        ...
        export default connect(mapStateToProps)(MotivationalWriterDashboard);
