...
class PatientSessionItem extends Component {
  render() {
    ...
    return (
      ...
      <div className="card card-body bg-light mb-3 mx-auto" style = {{maxWidth: '35rem'}}>
        ...
        <p style = {{color: "Black"}}>Psychologist Name: {session.psychologistId.name}</p>
        <h6 style = {{color: "Black"}}>Email required to connect with the Psychologist: {session.psychologistId.email}</h6>
      ...
      <p style = {{color: "Black"}}>Session Time: {session.paymentId.sessionTiming}</p>
      <p style = {{color: "Black"}}>Session Validity Date: {sessionValidityDate}</p>
      <p style = {{color: "Black"}}>Psychologist Name: Dr. {session.psychologistId.name}</p>
      <h6 style = {{color: "Black"}}>Click on the Video Chat button below to get redirected to your scheduled Zoom Video Chat Session with the booked Psychologist 
...
export default connect(mapStateToProps)(PatientSessionItem);
